...
export function CardNetwork({ item }: CardNetworkProps) {
  return (
    <article className="relative w-[259px] min-h-[334px] rounded-[32px] overflow-hidden group">
      ...
      <div className="absolute inset-0 w-full h-full p-6 text-black bg-gray-100 lg:group-hover:bg-transparent lg:group-hover:text-white duration-300 ease-in-out flex flex-col justify-between h-ful">
        <div className="w-12 aspect-square">{item.icon}</div>
